    ...
    <div className="font-[Plus_Jakarta_Sans,sans-serif] text-gray-700">
      ...
      <style>{`
        ...
        .card-adn:hover {
          ...
          box-shadow: 0 28px 64px rgba(10,37,64,0.18) !important;
        }
        .card-adn:hover .adn-image { transform: scale(1.06); }
        .adn-image { transition: transform 0.6s cubic-bezier(.22,1,.36,1); }
        ...
        .card-adn::before {
          ...
          width: 4px;
          background: linear-gradient(to bottom, #F7B500, #e6a800);
        ...
        .card-adn:hover::before { transform: scaleY(1); }
      ...
      <section className="py-28 px-6 overflow-hidden relative">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, rgba(240,246,255,0.96) 0%, rgba(255,255,255,0.93) 50%, rgba(254,250,240,0.96) 100%)",
            }}
          />
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              backgroundImage: "radial-gradient(rgba(10,37,64,0.025) 1px,transparent 1px)",
        ...
        <div className="absolute pointer-events-none rounded-full z-0"
          style={{ top: -100, right: -100, width: 500, height: 500, background: "radial-gradient(circle,rgba(247,181,0,0.10) 0%,transparent 70%)" }}
        />
        <div className="absolute pointer-events-none rounded-full z-0"
          style={{ bottom: -80, left: -80, width: 400, height: 400, background: "radial-gradient(circle,rgba(10,37,64,0.06) 0%,transparent 70%)" }}
        />
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-[1100px] mx-auto flex flex-col gap-8">
            {adnCards.map((card, i) => (
              <FadeUp key={i} delay={i * 0.18}>
                <div
                  className="card-adn bg-white rounded-[24px] overflow-hidden flex items-stretch relative"
                  style={{
                    boxShadow: "0 8px 40px rgba(10,37,64,0.10)",
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-center" style={{ padding: "48px 52px" }}>
                    <div className="flex items-center gap-3 mb-5">
                      ...
                      />
                      <h3 className="text-[28px] font-black text-[#0A2540] m-0 leading-tight">
                        {card.title}
                      </h3>
                    </div>
                    <p className="text-gray-500 leading-[1.9] mb-8 text-[15.5px] max-w-[500px]">
                      {card.desc}
                    </p>
                  ...
                  <div
                    style={{
                      width: 1,
                      background: "linear-gradient(to bottom, transparent, rgba(10,37,64,0.08) 30%, rgba(10,37,64,0.08) 70%, transparent)",
                      margin: "32px 0",
                      flexShrink: 0,
                    }}
                  />
                  ...
                  <div className="relative flex-shrink-0 overflow-hidden" style={{ width: 340 }}>
                    <div
                      ...
                      style={{ width: 70, background: "linear-gradient(to right, white, transparent)" }}
                    />
                    <Image
                      src={card.image}
                      alt={card.title}
                    ...
                    <div
                      ...
                      style={{ background: "linear-gradient(135deg,rgba(10,37,64,0.05) 0%,rgba(247,181,0,0.04) 100%)" }}
                    />
                  </div>
                  ...
                  <div
                    ...
                    style={{ background: "linear-gradient(90deg,#F7B500,rgba(247,181,0,0.08))" }}
                  />
                </div>
              </FadeUp>
            ))}
          ...
          <FadeUp delay={0.55} className="text-center mt-14">

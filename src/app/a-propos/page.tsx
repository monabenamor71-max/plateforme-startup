    ...
    <div className="font-[Plus_Jakarta_Sans,sans-serif] text-gray-700 bg-white">
      ...
      <section className="py-24 px-6 bg-[#0A2540] relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          style={{ background:"radial-gradient(circle,rgba(247,181,0,0.05) 0%,transparent 65%)" }}/>
        ...
        <div className="max-w-[1100px] mx-auto relative z-10">
          <FadeUp className="text-center mb-16">
            ...
            <h2 className="font-black text-white m-0 mb-4 leading-[1.12]"
              style={{ fontSize:"clamp(30px,4vw,52px)" }}>
              Les <span className="text-[#F7B500]">fondateurs</span> &amp; dirigeants
            </h2>
            <p className="text-white/45 text-[17px] max-w-[480px] mx-auto">
              Une équipe pluridisciplinaire unie autour d&apos;une vision commune
            </p>
          </FadeUp>
          ...
          <div className="grid grid-cols-4 gap-6">
            {team.map((member,i) => (
              <FadeUp key={i} delay={i*0.12}>
                <div className="team-card bg-white rounded-[20px] overflow-hidden"
                  ...
                  <div className="p-6">
                    <div className="w-[80px] h-[80px] rounded-full flex items-center justify-center
                      text-[22px] font-black text-[#F7B500] mx-auto mb-4"
                      style={{ background:"linear-gradient(135deg,#0A2540,#1a4080)",
                        border:"3px solid rgba(247,181,0,0.3)" }}>
                      {member.initials}
                    </div>
                    <div className="text-center">
                      <h3 className="text-[16px] font-black text-[#0A2540] mb-1 leading-snug">{member.name}</h3>
                      <p className="text-[12px] text-[#F7B500] font-bold mb-1">{member.role}</p>
                      <p className="text-[11px] text-gray-400 mb-4">{member.xp} d&apos;expérience</p>
                    </div>
                    <div className="team-reveal bg-[#f8faff] rounded-[12px] p-3 mb-4"
                      style={{ opacity:0, transform:"translateY(8px)", transition:"all .3s ease" }}>
                      <p className="text-gray-600 text-[12px] leading-[1.65] m-0 italic">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="marquee-track">
              {[...partners, ...partners].map((p,i) => (
                <div key={i} className="partner-card flex-shrink-0 min-w-[200px] rounded-[14px] p-[26px_28px] text-center"
                  style={{ background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.07)", transition:"all .3s ease" }}>
                  <div className="w-[44px] h-[44px] rounded-[10px] flex items-center justify-center
                    mx-auto mb-3 text-[#F7B500] font-black text-[13px]"
